...
class WebSocketServer extends Server 
{
    ...
    public function __construct(array $connectOptions = [], array $configOptions = []) 
    {
        try {
            ...
            $server_config = array_merge(Config::loadConfig('websocket')->get('server_config'), $configOptions);
    ...
    public function onStart(\swoole_server $server) 
    {
        ...
        //设置主进程别名
        Utils::setProcessName(VSWOOLE_WEBSOCKET_SERVER . ' master');
        //异步记录服务进程PID
        Utils::writePid($server->manager_pid, VSWOOLE_WEBSOCKET_SERVER . '_Manager');                                     
    }
    ...
    {
        //设置管理进程别名
        Utils::setProcessName(VSWOOLE_WEBSOCKET_SERVER . ' manager');                                     
    }
    ...
    public function onWorkerStart(\swoole_server $server, int $worker_id) 
    {
        ...
        Utils::setProcessName(VSWOOLE_WEBSOCKET_SERVER . $worker_name);
        //缓存配置
